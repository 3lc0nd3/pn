...
CREATE TABLE IF NOT EXISTS `empresa` (
  ...
  `marcas` text,
  `alcance_mercado` varchar(20) NOT NULL,
  `empleados` int(11) NOT NULL,
  `valor_activos` int(11) NOT NULL,
  `publica` int(11) NOT NULL,
  `file_certificado_constitucion` varchar(600) NOT NULL,
  `file_estado_financiero` varchar(600) NOT NULL,
  `file_consignacion` varchar(600) NOT NULL,
...
(1, 2, 1, 5, '777', 151, 'dire local', 'Sonido Local', '999-111-777', '300-300+300', 'http://hola.com', 'elcorreo@dominio.com', 'mi actividad', 'vainas', 'no hay marcas', '1', 324, 789456, 2, '7593A32FD1B48\n', '/home/usuariox/tmp/estado.pdf', 'bogota \n\n076-026400\n\n\n', 0, '2013-01-10 07:51:08'),
...
CREATE TABLE IF NOT EXISTS `persona` (
  ...
  KEY `id_ciudad` (`id_ciudad`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='persona' AUTO_INCREMENT=4 ;
...
(1, 'PNEIG 2013-1', '2013-01-01 05:00:00', '2013-01-31 11:00:00', '2013-01-10 00:00:00');
...
CREATE TABLE IF NOT EXISTS `texto` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='textos estaticos' AUTO_INCREMENT=11 ;
