...
--
-- Servidor: localhost
-- Tiempo de generación: 07-01-2013 a las 12:23:57
...
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='Cargo del empleado segun convocatoria' AUTO_INCREMENT=3 ;
...
(1, '1', 'Sin Origen', 1, 'Ninguno', 1, 1, 1),
...
CREATE TABLE IF NOT EXISTS `persona` (
  ...
  PRIMARY KEY (`id`),
  KEY `id_ciudad` (`id_ciudad`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='persona' AUTO_INCREMENT=1 ;
