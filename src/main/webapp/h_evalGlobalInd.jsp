        ...
        <div class="row">
            <div class="span8">
                ...
                <table border="1" width="70%">
                    ...
                    <tr &lt;%&ndash;style="display: none; visibility: hidden;"&ndash;%&gt;><th class="alert-info">Fortalezas</th></tr>
                    <tr &lt;%&ndash;style="display: none; visibility: hidden;"&ndash;%&gt;><td>
                        <textarea id="fortalezas" class="field span6" placeholder="<%=texto19.getTexto1()%>" rows="4" cols="10"></textarea>
                    </td></tr>
                    <tr &lt;%&ndash;style="display: none; visibility: hidden;"&ndash;%&gt;><th class="alert-info">Oportunidades de Mejora</th></tr>
                    <tr &lt;%&ndash;style="display: none; visibility: hidden;"&ndash;%&gt;><td>
