...
*/
                ...
                fileName = format("%s-%s.%s", "p"+participante.getIdParticipante(), df.format(new Date()), extencion);
                String path;
                ...
                if (!item.getName().equals("")) {
                    ...
                    if(participante.getUrlImagenParticipante() != null){ // TOCA BORRAR EL ARCHIVO ANTERIOR
                        File fileAnterior = new File(format("%s/%s", path, participante.getUrlImagenParticipante()));
                        fileAnterior.delete();
                    }
                    ...
                    participante.setUrlImagenParticipante(fileName);
                    swDAO.getHibernateTemplate().update(participante);

                    swDAO.saveNoticiaUsuarioActualizado(participante);
